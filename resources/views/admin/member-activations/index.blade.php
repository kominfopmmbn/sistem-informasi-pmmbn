...
@section('content')
    <div class="d-flex flex-column flex-md-row align-items-md-center justify-content-between gap-3 mb-4">
        <h4 class="fw-bold mb-0 py-3">Aktivasi Anggota</h4>
    </div>
                    ...
                    @forelse ($members as $item)
                        <tr>
                            ...
                            <td class="text-end">
                                ...
                                @endcan
                                @can('members.delete')
                                    <form action="{{ route('admin.member-activations.destroy', ['member_activation' => $item]) }}" method="POST"
                                        class="d-inline" onsubmit="return confirm('Hapus Aktivasi Anggota Ini?');">
                                        @csrf
                                        @method('DELETE')
