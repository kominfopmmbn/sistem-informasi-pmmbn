...
<section class="py-5">
    <div class="container">
        <div class="row align-items-center bg-white rounded-4 shadow-sm p-5 border">
            ...
            <div class="col-lg-6 text-center">
                <div class="bg-brand rounded-4 mx-auto position-relative shadow"
                    style="width: 80%; height: 200px; transform: rotate(-5deg);">
                    <div class="position-absolute bottom-0 end-0 p-3">
                        <div class="bg-white rounded-circle d-inline-block" style="width: 40px; height: 40px;">
                        </div>
                    </div>
                </div>
            </div>
